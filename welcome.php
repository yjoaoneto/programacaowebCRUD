...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#contact">Ola</a></li>
          <li><a class="getstarted scrollto" href="nomes.php">Acessar Usuarios</a></li>
          <li><a class="getstarted scrollto" id="delete" href="logout.php ">Logout</a></li>
        </ul>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      ...
      <div class="container-foto" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              ...
              <img id="foto-grupo" src="assets/img/projetophp/fotogrupo.jpeg" class="grupo" alt="grupo">
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <h1 class="my-5">
          <h2>Bem-vindos</h2>
          <p>Oi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>! Bem vindo ao nosso site</h1></p>
        </header>
        <div class="row botao">
          <div class="row coluna">
        <a class="bta" href="nomes.php" ><button class="botao1" type="submit">Ver Usuarios Cadastrados</button></a>
        <a class="bta" href="logout.php"><button class="botao2"type="submit" id="delete">Logout</button>
          </div>
        </div>
